...
<head>
    <meta charset="utf-8">
    <title>Social C-Suite Convention & Awards | Stimulus Research Services</title>
        ...
        <div class="main-box">
        	...
        	<div class="auto-container clearfix">
            	...
            	<div class="logo-box">
                	...
                	<div class="logo">
                        <a href="index.php">
                            <img style="max-width: 105px;" src="images/logo.png" alt="World Business Conclave" title="World Business Conclave">
                        </a>
                    </div>
                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                            ...
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown"><a href="speakers.html">IP</a>

                                    <ul>

                                        <li><a href="speakers.html">Social C-Suite</a></li>

                                        <li><a href="speakers-detail.html">Global Luxuries Decode</a></li>

                                        <li><a href="speakers-detail.html">Global Platinum Award</a></li>

<?php include('header-main.php'); ?>
    ...
    <section class="banner-section">
        ...
        <div class="banner-carousel owl-carousel owl-theme">
            ...
            <div class="slide-item" style="background-image: url(images/main-slider/1.webp);">
                ...
                <div class="auto-container">
                    ...
                    <div class="content-box">
                        ...
                        <ul class="info-list">
                            ...
                            <li><span class="icon fa fa-map-marker-alt"></span> Dubai, UAE</li>

                        </ul>

                        <div class="btn-box"><a href="buy-ticket.html" class="theme-btn btn-style-two"><span class="btn-title">Make A Reservation</span></a></div>
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="inner-column">
                        ...
                        <div class="sec-title">
                            ...
                            <span class="title">ABOUT WBC</span>

                            <!-- <h2>Welcome to the World Digital Conference 2023</h2> -->

                            <div class="text">
                                World Business Conclave  is a renowned name in culminating Intellectual Property Awards and Conclaves on both national and global platforms. 
                                All the events organized are aimed towards creating a space for enhanced brand communication and positioning using industry-leading technology, customer support and blue-chip networking. 
                                We build a space where independent creative professionals can support each other and grow together.
                                <br />
                                <br />
                                These award functions and conclaves we organize cover the agenda of concurrent issues, discuss the concerns, and showcase them through different media channels across the world. Thought-provoking panel discussions by influential personalities and dignitaries across key business industries were a distinct feature of the Conclave.
                            </div>
            ...
            <div class="row">
                ...
                <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    ...
                    <div class="inner-box">
                        ...
                        <div class="icon-box">
                            <img src="/images/resource/Group0-7.webp" alt="">
                        </div>

                        <h4><a href="#">Social C-Suite</a></h4>

                        <div class="text">Personal Profiling is the art of creating an unmatched niche with hybrid marketing strategies. By organically creating a collection of high quality content that reflects your personality, thoughts, opinions & interests.</div>
                ...
                <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    ...
                    <div class="inner-box">
                        ...
                        <div class="icon-box">
                            <img src="/images/resource/465123.webp" alt="">
                        </div>

                        <h4><a href="#">GLOBE LUXURIE DECODE</a></h4>

                        <div class="text">To celebrate India-UAE Success Story, Stimulus organized one of its kind GLOBE LUXURIÉ Decode 2017 Awards– that was a confluence of 150 international luxury brands under one roof.</div>
                ...
                <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                    ...
                    <div class="inner-box">
                        ...
                        <div class="icon-box">
                            <img src="/images/resource/2016.webp" alt="">
                        </div>

                        <h4><a href="#">GLOBE PLATINUM AWARDS</a></h4>

                        <div class="text">The coveted GLOBE Platinum Awards 2016 recognized the top brands and business leaders for their business excellence, innovative marketing techniques, and commendable work ethics across the Asia Pacific.</div>
                ...
                <div class="speaker-block col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="inner-box">
                        ...
                        <div class="image-box">
                            ...
                            <figure class="image"><a href="speakers-detail.html"><img src="images/resource/speaker.jpg" alt=""></a></figure> 
                        ...
                        <div class="info-box">
                            ...
                            <div class="inner">
                                ...
                                <h4 class="name"><a href="speakers-detail.html">Sanjana Mohan</a></h4>
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    ...
                    <div class="inner-column">
                        ...
                        <div class="sec-title">
                            ...
                            <h2>Why Choose Social C-Suite?</h2>
    ...
    <section class="clients-section">
        ...
        <div class="auto-container">
            ...
            <div class="sec-title">
                ...
                <span class="title">Our Partner</span>
